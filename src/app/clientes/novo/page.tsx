...
export default function NovoPage() {
	return (
		<div className='min-w-full flex flex-col gap-5 border border-gray-300 rounded-lg xss:p-3 sm:p-6'>
			...
			<form className='flex flex-col gap-5'>
				...
				<div className='flex items-center justify-end gap-4'>
					<button
						type='reset'
						className='text-[14px]  font-bold border border-gray-300 px-3 py-2 rounded-lg hover:bg-blue-100 hover:text-blue-900 hover:shadow-lg cursor-pointer'>
						Cancelar
					</button>
					<button
						type='submit'
						className=' xss:text-[12px] xs:text-[14px] font-bold bg-blue-900 text-white px-3 py-2 rounded-lg'>
						Cadastrar Cliente
					</button>
				</div>
			</form>
